...
/*		
		...
		Rational rational8 = new Rational(270, 192);
		System.out.println(rational8.reduce());
*/
		Rational rational9 = new Rational(5, 7);
		Rational rational10 = new Rational(3, 5);
		System.out.println(rational9.add(rational10));
		
		Rational rational11 = new Rational(5, 8);
		Rational rational12 = new Rational(3, 16);
		System.out.println(rational11.add(rational12));
	}
}
